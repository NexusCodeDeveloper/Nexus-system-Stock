export const getItems = (sale) => {
  ...
  if (sale.producto || sale.precio != null || sale.cantidad != null) {
    return [{
...
export const getUnidadesNetas = (sale) => {
  if (!sale || sale.estado === 'devuelta') return 0;
...
export const getTotalNeto = (sale) => {
  if (!sale || sale.estado === 'devuelta') return 0;
